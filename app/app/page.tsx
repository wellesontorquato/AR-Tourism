...
const Icons = {
  ...
  CameraOff: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M21 21H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3l2.5-3h4.14"></path>
      <path d="M14.5 4h-5L7 7H4"></path>
    ...
    <main className="relative h-[100dvh] w-full bg-neutral-900 overflow-hidden text-white font-sans selection:bg-white/20">
              ...
              >
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-bold leading-tight truncate drop-shadow-sm">
                      {poi.name}
                    </h3>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 pb-8 pt-20 px-6 bg-gradient-to-t from-black/90 to-transparent flex items-end justify-between pointer-events-none">
        ...
        <div className="pointer-events-auto flex flex-col items-center gap-1">
          <button
            ...
            className={`flex h-12 w-12 items-center justify-center rounded-full transition-all duration-300 ${
              heading !== null
                ...
                : "bg-neutral-800/60 text-white/50 border border-white/5"
            } backdrop-blur-md`}
          >
            <div
              style={{
          ...
          {headingErr && (
            <span className="text-[10px] text-red-300 bg-black/50 px-1 rounded">
              {headingErr}
            </span>
          )}
        </div>
